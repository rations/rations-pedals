/*
 * verbengine.h -- copied from WDL, as vendored in iPlug2.
 * Copyright (C) 2005 and later Cockos Incorporated. Original licence: zlib-style,
 * reproduced in the file's own header immediately below. See NOTICE.
 *
 * Redistributed as part of Rations; the zlib terms are already accepted in this
 * tree by AudioDSPTools' ResamplingContainer.h.

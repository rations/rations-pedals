// Rations Chorus — the plug-in factory. Two classes: the audio component and its controller.
...
namespace chorus
{
using Processor = PedalProcessor<ChorusTraits>;
using Controller = PedalController<ChorusTraits>;
} // namespace chorus
} // namespace Rations

BEGIN_FACTORY_DEF(stringCompanyName, stringCompanyWeb, stringCompanyEmail, 2)

DEF_CLASS(Rations::chorus::kProcessorUID, Steinberg::PClassInfo::kManyInstances,
          kVstAudioEffectClass, stringPluginName, Steinberg::Vst::kDistributable, "Fx|Modulation",
          FULL_VERSION_STR, kVstVersionString, Rations::chorus::Processor::createInstance, nullptr)

DEF_CLASS(Rations::chorus::kControllerUID, Steinberg::PClassInfo::kManyInstances,
          kVstComponentControllerClass, stringPluginName "Controller", 0, "", FULL_VERSION_STR,
          kVstVersionString, Rations::chorus::Controller::createInstance, nullptr)
